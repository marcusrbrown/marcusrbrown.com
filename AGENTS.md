...
**Stack:** React 19 + Vite 8 + TypeScript 6.0+ + pnpm 11+ + Node 22+
...
| `fro-bot.yaml` | PR events, `@fro-bot` comment mentions (issue/PR/discussion), issues, scheduled (03:30/15:30 UTC), `workflow_dispatch` | AI PR review, daily maintenance & autoheal reports |
